...
#define QT_MOC_LITERAL(idx, ofs, len) \
    ...
    qptrdiff(offsetof(qt_meta_stringdata_ROMDevice_t, stringdata0) + ofs \
        - idx * sizeof(QByteArrayData)) \
    )
static const qt_meta_stringdata_ROMDevice_t qt_meta_stringdata_ROMDevice = {
    {
QT_MOC_LITERAL(0, 0, 9) // "ROMDevice"
...
QT_INIT_METAOBJECT const QMetaObject ROMDevice::staticMetaObject = { {
    QMetaObject::SuperData::link<BusDevice::staticMetaObject>(),
    qt_meta_stringdata_ROMDevice.data,
