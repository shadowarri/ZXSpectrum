...
#define QT_MOC_LITERAL(idx, ofs, len) \
    ...
    qptrdiff(offsetof(qt_meta_stringdata_RAMDevice_t, stringdata0) + ofs \
        - idx * sizeof(QByteArrayData)) \
    )
static const qt_meta_stringdata_RAMDevice_t qt_meta_stringdata_RAMDevice = {
    {
QT_MOC_LITERAL(0, 0, 9) // "RAMDevice"
...
QT_INIT_METAOBJECT const QMetaObject RAMDevice::staticMetaObject = { {
    QMetaObject::SuperData::link<BusDevice::staticMetaObject>(),
    qt_meta_stringdata_RAMDevice.data,
